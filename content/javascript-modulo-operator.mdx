...
*This blog is a project from Josh Comeau's [Joy of React](https://joyofreact.com) course. This post, including the interactive illustrations herein, was provided by Josh. One of our assignments was to implement the animations within the interactive illustrations. See [Adapting Parcel Projects to be Next.js Routes](/adapting-parcel-projects) for more. —John*
