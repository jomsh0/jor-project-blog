...
*This blog is a project from Josh Comeau's [Joy of React](https://joyofreact.com) course. This post, including the interactive illustrations, was provided in the project materials. One of our assignments was to implement the animations within the illustrations. For more from the course, see [Adapting Parcel Projects for Next.js](/adapting-parcel-projects). —John*
